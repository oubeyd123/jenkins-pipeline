...
def applyConfigValue(String key, String value) {
    switch (key) {
        ...
        case 'REGISTRY_CRED_ID':
            env.REGISTRY_CRED_ID = value
            break
        case 'GIT_CRED_ID':
            env.GIT_CRED_ID = value
            break
        case 'BUILD_AGENT_LABEL':
            env.BUILD_AGENT_LABEL = value
            break
        case 'DEV_DEPLOY_AGENT_LABEL':
            env.DEV_DEPLOY_AGENT_LABEL = value
            break
        ...
        case 'DEV_CONTAINER_NAME':
            env.DEV_CONTAINER_NAME = value
            break
        case 'DEV_CONTAINER_PORTS':
            env.DEV_CONTAINER_PORTS = value
            break
        case 'WSO2_BASE_IMAGE':
            env.WSO2_BASE_IMAGE = value
            break
        case 'WSO2_SERVER_HOME':
            env.WSO2_SERVER_HOME = value
            break
        case 'TRIVY_FS_CACHE_DIR':
            env.TRIVY_FS_CACHE_DIR = value
            break
        case 'TRIVY_IMAGE_CACHE_DIR':
            env.TRIVY_IMAGE_CACHE_DIR = value
            break
        case 'TRIVY_SKIP_DB_UPDATE':
            env.TRIVY_SKIP_DB_UPDATE = value
            break
        case 'TRIVY_TIMEOUT':
